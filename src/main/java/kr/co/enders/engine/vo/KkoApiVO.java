...
public class KkoApiVO {
	...
	private String legalCf;
	private String taskNm;
	private String bachGubun;
	private String bachDate;
	...
	public String getBachGubun() {
		return bachGubun;
	}
	public void setBachGubun(String bachGubun) {
		this.bachGubun = bachGubun;
	}
	public String getBachDate() {
		return bachDate;
	}
	public void setBachDate(String bachDate) {
