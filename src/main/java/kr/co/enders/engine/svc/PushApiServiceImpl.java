...
import kr.co.enders.engine.dao.PushApiDAO;
...
public class PushApiServiceImpl  implements PushApiService {
	...
	@Autowired
	private PushApiDAO pushApiDAO;

	
	@Override
	public int insertPushApiStg(List<PushApiVO> listReceiver) throws Exception {
		return pushApiDAO.insertPushApiStg(listReceiver);
	}
