...
import kr.co.enders.engine.dao.TsEmailApiDAO;

@Service("tsEmailApiService") 
public class TsEmailApiServiceImpl  implements TsEmailApiService {

	@Autowired
	private TsEmailApiDAO tsEmailApiDAO;

	
	@Override
	public int insertTsEmailApiStg(List<EmailApiVO> vo) throws Exception {
		return tsEmailApiDAO.insertTsEmailApiStg(vo);
	}
